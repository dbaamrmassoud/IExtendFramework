...
namespace IExtendFramework.Controls.AdvancedMessageBox
{
	/// <summary>
	/// Provides data for the <see cref="T:IExtendFramework.Controls.AdvancedMessageBox.TaskDialog.Showing"/> event.
	/// </summary>
	...
	/// <summary>
	/// Provides data for the <see cref="T:IExtendFramework.Controls.AdvancedMessageBox.TaskDialog.Closed"/> event.
	/// </summary>

    ...
    internal class PPMContext : Pointer
    {
        ...
        virtual public int NumStats
        {
            get
            {
                if (Memory != null)
                {
                    numStats = Utilities.readShortLittleEndian(Memory, Address) & 0xffff;
                }
                return numStats;
            }
        ...
        //UPGRADE_NOTE: The initialization of  'unionSize' was moved to static method 'IExtendFramework.IO.Compression.Rar.Unpack.PPM.PPMContext'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
        ...
        internal int getSuffix()
        {
            if (Memory != null)
            {
                suffix = Utilities.readIntLittleEndian(Memory, Address + 8);
            }
            return suffix;
        }
        ...
        internal void setSuffix(int suffix)
        {
            ...
            if (Memory != null)
            {
                Utilities.WriteLittleEndian(Memory, Address + 8, suffix);
            }
        }
        ...
        {
            return (Utilities.URShift((summ + (1 << (shift - round))), (shift)));
        }

    ...
    public class BigDecimal : IComparable<BigDecimal>, IEquatable<BigDecimal>
    {
        ...
        public static object ToInteger(Config/*!*/ config, BigDecimal/*!*/ x)
        {
            if (IsFinite(x))
            {
                ...
                return BigInteger.Multiply(d, BigInteger.Create(10).Power(i.Exponent - digits.Length));
            }
            else
            {
                return null;
        ...
        public static BigDecimal Divide(Config config, BigDecimal x, BigDecimal y, int limit, out BigDecimal remainder)
        {
            ...
            int minPrecision = (int)System.Math.Ceiling((double)limit / BASE_FIG) + 1;
            Fraction rFraction;
        ...
        public static BigDecimal/*!*/ SquareRoot(Config/*!*/ config, BigDecimal/*!*/ x, int limit)
        {
            ...
            prec = prec - System.Math.Max(x.PrecisionDigits, limit + DOUBLE_FIG);
            ...
            BigDecimal y = BigDecimal.Create(config, System.Math.Sqrt(d));
            ...
            int iterations = System.Math.Max(limit, max_iterations);
            int i = 0;
            while (i < iterations)
            {
        ...
        private static BigDecimal InternalAdd(Config config, BigDecimal x, BigDecimal y, int limit)
        {
            ...
            int exponent = System.Math.Max(x._exponent, y._exponent);
            int sign = x._sign;
            Fraction fraction;
            int exponentDiff;
        ...
        #region Custom code
        public static implicit operator BigDecimal(uint d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        ...
        public static implicit operator BigDecimal(short d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(long d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(float d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(ushort d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(ulong d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(byte d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(sbyte d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }
        public static implicit operator BigDecimal(char d)
        {
            Config dummy = new Config();
            return Create(dummy, d.ToString());
        }

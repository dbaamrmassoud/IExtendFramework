...
namespace IExtendFramework.Mathematics
{
    public static partial class Math
    {
        ...
        {
            return (precision < 16) ? _RoundPowersOfTens[precision] : System.Math.Pow(10, precision);
        }
        ...
        public static double ErfComplement(double v0)
        {
            ...
            if (a <= 4.0)
            {
                ...
                res = System.Math.Exp(-a * a) * numer / denom;
            }
            else
            {
                ...
                for (int i = nTerms; i > 0; i--)
                {
                    ...
                    res += System.Math.Exp(-term) / (term + sq);
                }

                res = h * a * System.Math.Exp(-sq) / System.Math.PI * (res * 2 + 1.0 / sq);
            }
        ...
        public static double Gamma(double v0)
        {
            ...
            if (v0 < -150.0)
            {
                ...
                res = System.Math.Pow(System.Math.PI, 1.5) / SinPi(v0);
                res *= System.Math.Pow(2.0, v0);
        ...
        public static double LogGamma(double v0)
        {
            ...
            if (v0 < 0.0)
            {
                ...
                res = System.Math.Log(System.Math.PI / AbsSinPi(v0));
        ...
        {
            double res = System.Math.Abs(v0) % 2.0;

            if (res < 0.25)
            {
                res = System.Math.Sin(res * System.Math.PI);
            }
            else if (res < 0.75)
            {
                res = System.Math.Cos((res - 0.5) * System.Math.PI);
            }
            else if (res < 1.25)
            {
                res = -System.Math.Sin((res - 1.0) * System.Math.PI);
            }
            else if (res < 1.75)
            {
                res = -System.Math.Cos((res - 1.5) * System.Math.PI);
            }
            else
            {
                res = System.Math.Sin((res - 2.0) * System.Math.PI);
            }
        ...
        {
            double res = System.Math.Abs(v0) % 1.0;
        ...
        private static double PositiveGamma(double v0)
        {
            ...
            res /= System.Math.Exp(vg);
            if (v0 < 120.0)
            {
                res *= System.Math.Pow(vg, v0 - 0.5);
            }
            else
            {
                // Use a smaller exponent if we're in danger of overflowing Math.Pow
                double sqrt = System.Math.Pow(vg, v0 / 2.0 - 0.25);
                res *= sqrt;
                res *= sqrt;
            }
        ...
        {
            double vg = v0 + 12.644565; // v0 + g - 0.5
            double res = System.Math.Log(GammaRationalFunc(v0)) - vg;
            res += (v0 - 0.5) * System.Math.Log(vg);
        ...
        internal static string BigIntegerToString(uint[] d, int sign, int radix, bool lowerCase)
        {
            if (radix < 2)
            {
                throw new ArgumentOutOfRangeException("radix", radix, "radix must be >= 2");
            }
            if (radix > 36)
            {
                throw new ArgumentOutOfRangeException("radix", radix, "radix must be <= 36");
            }
        ...
        public static BigInt GetRandBits(this System.Random generator, int bits)
        {
        ...
        public static BigInt Random(this System.Random generator, BigInt limit)
        {

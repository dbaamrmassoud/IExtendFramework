    ...
    internal class RarMemBlock : Pointer
    {
        ...
        internal int Stamp
        {
            get
            {
                if (Memory != null)
                {
                    stamp = Utilities.readShortLittleEndian(Memory, Address) & 0xffff;
                }
                return stamp;
            }
        ...
        internal int GetNext()
        {
            if (Memory != null)
            {
                next = Utilities.readIntLittleEndian(Memory, Address + 4);
            }
            return next;
        }
        ...
        internal void SetNext(int next)
        {
            ...
            if (Memory != null)
            {
                Utilities.WriteLittleEndian(Memory, Address + 4, next);
            }
        }
        ...
        internal int GetNU()
        {
            if (Memory != null)
            {
                NU = Utilities.readShortLittleEndian(Memory, Address + 2) & 0xffff;
            }
            return NU;
        }
        ...
        internal void SetNU(int nu)
        {
            ...
            if (Memory != null)
            {
                Utilities.WriteLittleEndian(Memory, Address + 2, (short)nu);
            }
        }
        ...
        internal int GetPrev()
        {
            if (Memory != null)
            {
                prev = Utilities.readIntLittleEndian(Memory, Address + 8);
            }
            return prev;
        }
        ...
        internal void SetPrev(int prev)
        {
            ...
            if (Memory != null)
            {
                Utilities.WriteLittleEndian(Memory, Address + 8, prev);
            }
        }
    }
}
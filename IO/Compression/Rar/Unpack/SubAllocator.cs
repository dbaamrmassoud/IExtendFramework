...
namespace IExtendFramework.IO.Compression.Rar.Unpack.PPM
{
    internal class SubAllocator
    {
        ...
        //UPGRADE_NOTE: The initialization of  'UNIT_SIZE' was moved to static method 'IExtendFramework.IO.Compression.Rar.Unpack.PPM.SubAllocator'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1005'"
        ...
        {
            int i, k;
            Utilities.Fill(heap, freeListPos, freeListPos + sizeOfFreeList(), (byte)0);

...
namespace IExtendFramework.IO.Compression.Zip.Compression.Streams 
{
   ...
   /// </remarks>
	...
	/// as the <see cref="IExtendFramework.IO.Compression.GZip.GZipInputStream">GZipInputStream</see>.
	///

...
using IExtendFramework.IO.Compression.Zip.Compression;
using IExtendFramework.IO.Compression.Zip.Compression.Streams;
using IExtendFramework.IO.Compression.Encryption;
...
namespace IExtendFramework.IO.Compression.Zip 
{
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		/// </exception>
		/// <exception name="IExtendFramework.IO.Compression.ZipException">
